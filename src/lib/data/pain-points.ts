...
export const painPoints: PainPoint[] = [
  {
    ...
    stat: "Le ressenti humain est le signal n°1 que la machine ne capte pas",
    icon: UserRoundX,
  },
  {
    id: "actions-missing",
    ...
    description:
      "Les outils CSM actuels priorisent les comptes à risque, mais laissent le CSM seul face à la question : par quoi commencer, quoi écrire, à qui escalader ? Aucun plan d'action personnalisé selon le profil interlocuteur.",
    verbatim:
  ...
  },
  {
    ...
    stat: "Au-delà de 100 clients, le pilotage manuel décroche systématiquement",
    icon: KeyboardOff,
  },
];
