...
export const features: Feature[] = [
  {
    ...
    inputs: [
      "Usage produit (Amplitude, Mixpanel)",
      "Données contractuelles (HubSpot, Salesforce)",
      "Facturation et ARR (Stripe, Chargebee)",
      "CSAT et tickets (Zendesk)",
      "Sentiment CR (Gong.io, Modjo)",
      "Notation hebdo CSM (formulaire interne)",
    ],
  ...
  },
  {
    ...
    inputs: [
      "Données licences engagées (HubSpot, Salesforce, Stripe, Chargebee)",
      "Données usage réel (Amplitude, Mixpanel)",
