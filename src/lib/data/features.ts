...
export const features: Feature[] = [
  ...
  },
  {
    ...
    engine: "Agent IA qui propose reprise contact préventive, remise anticipée avec marge protégée, conversation de renouvellement anticipée, escalade compte stratégique",
  ...
  },
  {
    ...
    value: "Préparer la conversation de renouvellement avec un livrable qui prouve la valeur délivrée",
    icon: FileText,
