...
export const personas: Persona[] = [
  ...
  },
  {
    ...
    ambition: "Brancher Revelo nativement dans HubSpot et Salesforce sans demander à l'équipe d'ouvrir un 5e onglet, puis projeter le Revenue à risque au QBR.",
