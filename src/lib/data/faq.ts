...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Intégration native HubSpot ou Salesforce en 3 jours sans formation (validé par Sarah RevOps). Pilote complet en 10 jours ouvrés : connecteur CRM branché, Stripe ou Chargebee synchronisé, Zendesk relié, Amplitude ou Mixpanel branché pour l'usage, Gong.io ou Modjo pour le sentiment CR, premier batch de plans d'action IA généré. Adoption observée : 95 % en 2 semaines parce que les CSM ne changent pas leurs habitudes, ils restent dans le CRM.",
  },
  {
    question: "Quels connecteurs natifs en standard ?",
    answer:
      "Côté CRM, HubSpot en priorité (cible n° 1 sur nos interviews terrain, 3 interviewés sur 5) et Salesforce. Côté usage produit, Amplitude et Mixpanel en connecteur natif. Côté ARR et facturation, Stripe et Chargebee. Côté support, Zendesk pour le CSAT et les tickets. Pour le sentiment extrait des CR de réunion, Gong.io et Modjo. La notation collaborative CSM passe par un formulaire interne Revelo. Le palier API Advanced ouvre un webhook MCP pour orchestrer l'agent depuis n'importe quel outil compatible.",
  },
  {
